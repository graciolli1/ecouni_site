...
namespace ecouni_site.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,CategoriaId,Preco,Nome")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,CategoriaId,Preco,Nome")] Produto produto)
        {
